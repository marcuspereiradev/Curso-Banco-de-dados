...
INSERT INTO projeto
	VALUES(NULL, 'E-Commerce', 230000, '2018-08-14', 170, 1),
		  (NULL, 'Gestão Hospitalar', 420000, '2018-07-20', 225, 0.5);
...
-- GROUP BY - Resultado de uma função de agregação dividido por grupo de individuos.
...
-- Subquery
-- Exibir o funcionario que revebe o maior salário
...
-- Exibir o funcionario que revebe acima da média
